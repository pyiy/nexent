...
interface TopNavbarProps {
  /** Custom content to display on the left side (replaces default logo) */
  leftContent?: React.ReactNode;
  /** Custom content to display on the right side (replaces default nav items) */
 ...
 * Can be customized with leftContent and rightContent props
 */
export function TopNavbar({ leftContent, rightContent }: TopNavbarProps) {
  ...
  // Default right content - Navigation links and user controls
  ...
  return (
    ...
    >
      {/* Left section - Custom or default logo */}
      {leftContent || defaultLeftContent}

      {/* Right section - Custom or default navigation */}
      {rightContent || defaultRightContent}

      {/* Mobile hamburger menu button - only show if using default content */}
